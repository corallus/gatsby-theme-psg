...
const Footer = () => {
  const { menuItems, social } = useSiteMetadata()
  return (
        ...
        <div className="row justify-content-end">
          <div className="col-12 col-md-3 pl-0">
            <img
              src={icon}
              alt="Icon"
              style={{ width: '165px', marginTop: '-60px' }}
            />
          </div>
          <div className="col-12 col-md-9 footer-links d-flex align-content-end flex-wrap py-3">
            ...
            <div>
              <p className="text-muted text-xs mb-0">
                <small>© Copyright 2019, All Rights Reserved. <a href="/algemenevoorwaarden.pdf">General Conditions of Gigi in Concert</a> apply to this event.</small>
              </p>
            </div>
          </div>
        </div>
